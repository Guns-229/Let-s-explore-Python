...
for l in lst:
    ...
    tk.Checkbutton(root, text=var, variable=l).pack(side=tk.LEFT, anchor=tk.W, expand=tk.YES)
tk.Button(root, text="Next", width=20, command=display_choice).pack(side=tk.RIGHT)
