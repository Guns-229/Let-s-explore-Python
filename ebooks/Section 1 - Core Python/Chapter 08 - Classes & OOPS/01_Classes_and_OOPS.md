...
```
    ...
    <ipython-input-67-75297f6bbee6> in <module>
    ----> 1 foo._vers.append(0.011)
    

    AttributeError: 'Foo' object has no attribute '_vers'
...
```
    ...
    in __init__ Ram Ram
    <__main__.MyNewTest object at 0x10f816550>
...
```
    ...
    in __init__ test
    <__main__.NewDistance object at 0x10f827490> <class '__main__.NewDistance'>
...
```
    ...
    4554502608 4554502608 4554502608
...
```
    ...
    same id's for all 4554502352 4554502352 4554502352
